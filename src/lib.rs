...
#[derive(Debug)]
pub struct PrimeVeilProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeVeilProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeVeil processing");
    
    let mut processor = PrimeVeilProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeVeilProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeVeilProcessor::new(false);
